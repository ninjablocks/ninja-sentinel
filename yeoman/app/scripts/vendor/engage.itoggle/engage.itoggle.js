	...
	$.fn.iToggle = function(options) {
		...
		function slide($object, radio){
			...
			if($object.hasClass('iTon')){
				...
				$object.animate({backgroundPositionX:'100%'}, settings.speed, settings.easing, function(){
				...
				$object.animate({backgroundPositionX:'0%'}, settings.speed, settings.easing, function(){
